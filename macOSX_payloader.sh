...
curl -fsSL https://raw.github.com/Hawaiideveloper/MERN_nodeJS_setup/macOSX_installer/automated_preinstall.sh | /bin/bash
...
#curl -fsSL $macOSX_Installer/automated_preinstall.sh 
#curl -fsSL $macOSX_Installer/post_installer.sh 
